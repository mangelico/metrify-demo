...
**Estado general:** `[x]` Completo — 98 tests pasando, CI configurado
...
- [x] Las 6 tools responden desde el gateway
- [x] AssemblyAI cobra por minuto correctamente
- [x] Apify maneja el ciclo async sin cobrar si falla
- [x] Todos los errores tienen formato consistente
- [x] Firecrawl extrae contenido de URL y cobra por página correctamente
- [x] Test suite completo corriendo en CI
