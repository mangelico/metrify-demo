...
**Estado general:** `[ ]` Bloqueado hasta completar Sprint 02
...
- [ ] Puedo llamar OpenAI, Anthropic y Stability AI desde el mismo endpoint
- [ ] Cada tool calcula su costo con su propia unidad (tokens / imagen)
- [ ] El router despacha correctamente y falla limpiamente si tool no existe
- [ ] Rate limiting activo y testeable
